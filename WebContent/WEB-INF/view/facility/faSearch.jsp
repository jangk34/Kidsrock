...
<html lang="en-US">
   <head>
     ...
     <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/bootstrap.css">
      ...
      <link rel="stylesheet" href="<%=request.getContextPath()%>/bootstrap-3.3.2-dist/css/search1.css">
   ...
   <body class="size-1280 slide-to-left">
     ...
     <div style="border-top:5px solid #f2f2f2; border-bottom:2px solid #f2f2f2; border-left:1px solid #f2f2f2; border-right:1px solid #f2f2f2; padding:12px;">
       ...
       <div style="width:100%; padding-left:2px; padding-right:4px;">
        	<h4 style="text-align:center; text-border:30px;"><Strong>검색</Strong></h4>
        </div>
      </div>
	 ...
	 <input type="text" class="form-control" style="width:70%; margin-top:10%; margin-left:7%; float:left"  placeholder="시설명,주소,동으로 입력해주세요."/> <button style="width:15%; margin-top:10%; float:left;" class="btn btn-success">
	검색
	 </div>

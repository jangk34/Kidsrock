...
<html lang="en-US">
   <head>
     ...
     <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/bootstrap.css">
      <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/js/bootstrap.min.js">    
   ...
   <body class="size-1280 slide-to-left">
     ...
     <div style="border-top:5px solid #f2f2f2; border-bottom:2px solid #f2f2f2; border-left:1px solid #f2f2f2; border-right:1px solid #f2f2f2; padding:12px;">
       ...
       <div style="width:100%; padding-left:2px; padding-right:4px;">
        	<h4 style="text-align:center; text-border:30px;"><Strong>시설정보</Strong></h4>
        </div>
      </div>
		...
		<div class="col-md-12">
			...
			<div id="tab1" class="tabcontent">
                 ...
                 <!-- class="tabSurveyAud" -->
                  <li class="active" style="width: 20%;"><a data-toggle="tab"    href="#tabSurveyReg"  aria-expanded="true"  style="text-align:center"><h5>키즈카페</h5></a></li>
                  <li style="width: 20%;" ><a data-toggle="tab"   href="#tabVoteReg" aria-expanded="false"style="text-align:center"><h5>유치원</h5></a></li>
                  <li style="width: 28%;" ><a data-toggle="tab"   href="#tabVoteRe1" aria-expanded="false"style="text-align:center"><h5>기타</h5></a></li>
						<select style="width:30%; margin:2px" class="form-control" id="" name="Fapostaddr">
							<option value="1">*주소검색</option>
							<option value="2">서울시 양천구</option>
							<option value="3">서울시 성북구</option>
							<option value="2">서울시 마포구</option>
							<option value="3">서울시 강북구</option>
							<option value="2">서울시 강남구</option>
							<option value="3">서울시 성동구</option>
							<option value="2">서울시 노원구</option>
							<option value="3">서울시 강서구</option>
							<option value="2">서울시 용산구</option>
							<option value="3">서울시 구로구</option>
                 ...
                 <div class="tab-content">
                    ...
                    <div id="tabVoteRe1" class="tab-pane">
                       <div >기타</div>
                    </div>
	    ...
	    <img style="width:100%; height:250px;" onclick="javascript:location.href='/facility/fainfoDetail.do?fano=<%=fList.get(4).getFano() %>'" src="<%=request.getContextPath()%>/resources/img/header-1.jpg" style="height:5rem;" "alt="">
		<div style="height: 70px; width: 700px; opacity: 0.7; background: #333333b9; position: absolute; top: 180px;"></div>
		<h style="margin-bottom:55px; color:#FFFFFF" class="content-center-text-absolute white-text"><strong><%=fList.get(4).getFaname() %> <br> <%=fList.get(4).getFaaddr1() %></strong></h4>
	       ...
	       <!-- <div style="opacity:0.7; overlay:0.7; display:-webkit-inline-box; height:70px; position:absolute; width:100%; top:347px; bottom:100px; background:gray;"></div> -->
	        	 ...
	        	 <div class="col remove-padding contianer-relative">
	        	  <div class="item item-image clear-border" >  
	    <img style="width:100%; height:250px;" onclick="javascript:location.href='/facility/fainfoDetail.do?fano=<%=fList.get(5).getFano() %>'" src="<%=request.getContextPath()%>/resources/img/header-2.jpg" style="height:5rem;" "alt="">
	    <div style="height: 65px; width: 700px; opacity: 0.7; background: #333333b9; position: absolute; top: 184px;"></div>
	       <h4 style="margin-bottom:55px; color:#FFFFFF" class="content-center-text-absolute white-text"><strong><%=fList.get(5).getFaname() %> <br> <%=fList.get(5).getFaaddr1() %></strong></h4></div>
	       </div>
	       <% } %>
	        </section>

        ...
        <header>
         ...
         <div style="padding-top:15px"></div>
	       ...
	       <div class="container"> 
	        ...
	        <img onclick="javascript:location.href='/facility/fainfoList.do'" src="<%=request.getContextPath()%>/resources/img/info.svg" style="height:5rem;" "alt="">
	        <!-- 이미지 -->
	        <h4 class="margin-bottom">시설정보</h4>
	        </div>
	        <div class ="s-3 m-6 1-3 margin-bottom " style="border: 1px solid #bcbcbc;padding:18px"> 
	        <img onclick="javascript:location.href='/board/boardList.do'" src="<%=request.getContextPath()%>/resources/img/notice.svg" style="height:5rem;" "alt="" >
	        <!-- 이미지 -->
	        <h4 class="margin-bottom">공지사항</h4>
	        </div>
	        <div class ="s-3 m-6 1-3 margin-bottom " style="border: 1px solid #bcbcbc;padding:18px"> 
	        <img onclick="javascript:location.href='/qna/questionDetail.do'" src="<%=request.getContextPath()%>/resources/img/question.svg" style="height:5rem;" "alt="">
	        <!-- 이미지 -->
	        <h4 class="margin-bottom">질의응답</h4>
	        </div>
	        <div class ="s-3 m-6 1-3 margin-bottom " style="border: 1px solid #bcbcbc;padding:18px"> 
	        <img onclick="javascript:location.href='/community/communityOne.do'" src="<%=request.getContextPath()%>/resources/img/chat.svg" style="height:5rem;" "alt="">
	        <!-- 이미지 -->
